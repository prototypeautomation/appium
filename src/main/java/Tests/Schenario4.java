...
public class Schenario4 extends TestAbstractClass {
    @Test(priority = 3)
    public void SignUpwithValidPassword() throws InterruptedException {
        ...
        By txtAssert = By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.TextView");
        ...
        Thread.sleep(3000L);
        driver.findElement(txtPass1).sendKeys("123asd");
        Thread.sleep(3000L);
